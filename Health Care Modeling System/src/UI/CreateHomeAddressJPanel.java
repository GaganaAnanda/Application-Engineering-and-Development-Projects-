...
public class CreateHomeAddressJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblCreateHome.setText("Create Home Address");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
       ...
       // Step 1: Collect text from the field
        ...
        String firstName = fieldHomeFirstName.getText();
        String surName = fieldHomeSurname.getText();
        ...
        homeaddress.setFirstName(firstName);
        homeaddress.setSurName(surName);
        ...
        fieldHomeFirstName.setText("");
        fieldHomeSurname.setText("");
