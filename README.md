...
Run the Main class to start the application interface

Each project contains multiple modules and panels that allow role based navigation through business, health or library workflows.
